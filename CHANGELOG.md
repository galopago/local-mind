...
- Added raw capture read-warning reporting so unreadable saved captures appear in CLI, MCP, and local web inbox diagnostics instead of disappearing silently.
