...
| Tool | Description |
|------|-------------|
| `query_link(query, budget?, project?)` | Build a compact answer-ready packet from local memory, ranked wiki search, and graph-neighborhood context. |
