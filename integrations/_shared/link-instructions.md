...
After ingesting raw sources or making substantial wiki edits, run `python3 ~/link/link.py rebuild-backlinks ~/link` and `python3 ~/link/link.py validate ~/link` before saying the wiki is updated.
