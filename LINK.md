...
- When the human approves a captured proposal, run `python3 link.py accept-capture "<raw-capture-path>" . --index <n>`. If it reports a duplicate or conflict, stop and ask whether to update/archive the existing memory instead.
